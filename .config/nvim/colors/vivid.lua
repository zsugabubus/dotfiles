...
local theme = {
	...
	NonText = { fg = light and '#d1d0d3' or '#383848', ctermfg = 8 },
	...
	QuickFixLine = 'Search',
	Repeat = 'Conditional',
	Search = { fg = '#000000', bg = '#fdef39', ctermbg = 3, ctermfg = 0 },
	SignColumn = { fg = '#444444', bg = 'LineNr' },
	Special = 'Normal',
	SpecialChar = { fg = 'Constant', bold = true },
	SpecialKey = 'NonText',
	SpellBad = { undercurl = true },
	Statement = 'Keyword',
	StatusLine = { fg = light and '#313140' or '#f8ece8', bg = light and '#e8e8e8' or '#363a4a', cterm = { reverse = true }  },
	StatusLineBold = { fg = 'StatusLine', bg = 'StatusLine', bold = true, cterm = { bold = false } },
	...
	VertSplit = { fg = '#ababab' },
	Visual = { bg = light and '#a0d0ff' or '#4c5dfd', fg = dark and '#ffffff', ctermbg = 4, ctermfg = 0 },
	WarningMsg = { fg = '#933ab7', bg = '#e0d7f7', bold = true },
	WildMenu = { bg = 'Visual', fg = 'Visual', bold = true, ctermbg = 3, ctermfg = 0, cterm = { bold = false } },
	WinBar = 'Normal',
	WinBarNC = 'WinBar',
	...
	htmlH1 = { bold = true },
	mkdCode = { bg = '#e8e8e8' },
	mkdCodeDelimiter = { bg = 'mkdCode', bold = true },
