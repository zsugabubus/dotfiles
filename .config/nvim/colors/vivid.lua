...
local theme = {
	...
	Statement = 'Keyword',
	StatusLine = { fg = light and '#313140' or '#f8ece8', cterm = { reverse = true } },
	StatusLineNC = { fg = 'StatusLine' },
	StatusLineBold = { fg = 'StatusLine', bold = true },
	String = 'Constant',
	TabLine = { fg = light and '#404040' or '#d0ccd8', bg = light and '#e8e8e8' or '#363a4a' },
	TabLineFill = 'TabLine',
